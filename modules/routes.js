...
module.exports = {
  ...
  getCollabAlbums: (user_id)  => (typeof user_id  !== 'undefined' ? `/users/${ user_id }/albums`        : '/users/:user_id/c/albums'),      // Send albums that user is a collaborator on
  ...
  addMetaData:     (album_id) => (typeof album_id !== 'undefined' ? `/albums/${ album_id }/meta/add`    : '/albums/:album_id/meta/add'),
